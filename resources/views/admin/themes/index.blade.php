...
<div class="max-w-7xl mx-auto animate-fadeIn">
    ...
    <div class="flex space-x-4 mb-8 border-b border-slate-200">
        ...
        <a href="{{ route('admin.themes.index') }}" class="py-3 px-4 border-b-2 font-semibold text-sm border-emerald-600 text-emerald-600">Manage Themes</a>
        <a href="{{ route('admin.testimonials.index') }}" class="py-3 px-4 border-b-2 font-semibold text-sm border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300">Testimonials</a>
    </div>
